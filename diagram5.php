...
<html lang="en">
    <head>
        ...
        <title>Diagram 5 Volume & Tanggal (Datepicker) Menurut Jenis</title>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-primary p-3 active" href="diagram5.php">Diagram 5</a>
                </div>
            </div>
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                <div class="container-fluid">
                    <h1 class="text-center">Diagram 5 Volume & Tanggal (Datepicker) Menurut Jenis</h1>
