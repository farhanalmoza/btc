...
<html lang="en">
    <head>
        ...
        <title>Diagram 4 Volume & Tanggal (Datepicker) Menurut Jenis</title>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-primary p-3 active" href="diagram4.php">Diagram 4</a>
